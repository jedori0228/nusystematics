...
std::vector<double> RoundRobin(std::vector<double> new_points, std::vector<double> genie_weights){    
    ...
    std::vector<vector<double>> skippable_genie_weights; //holds genie weight with gaps
    std::vector<vector<double>> skippable_genie_param; //holds genie params with gaps
